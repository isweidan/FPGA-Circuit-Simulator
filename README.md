...
This repository contains our (System)Verilog and C language code for our ECE532 Project, which involved creating an end-to-end SPICE simulator on FPGA. 

Please refer to the [system introduction video](https://www.youtube.com/watch?v=Aq5WXmQQooo) for a brief overview of the project and final achievements.
